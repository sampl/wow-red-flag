...
// Grouped here purely to make it easier to tag related entries consistently;
// the exported list is flattened and alphabetized (groups are not shown in the UI).
const flagSources: RedFlagSource[] = [
  {
...
export const redFlags: RedFlag[] = flagSources
  .flatMap(({ flags }) => flags)
